...
import { getposts, getPostById, deletePost, editPost, postLink, getPostByUser, postLike, deleteLike, reposts } from "../controllers/post.controller.js"
...
postsRouter.post("/reposts", reposts);
